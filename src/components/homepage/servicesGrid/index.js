...
export default function ServicesGrid({
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 grid grid-cols-1 gap-8 md:w-9/12 lg:max-w-6xl lg:grid-cols-2 lg:place-items-center">
        <div className="text-center lg:text-left lg:mr-24">
          <h2 className="text-gray text-3xl font-bold font-secondary mb-6 lg:leading-normal">
          ...
          <p className="text-lightGray font-opensans text-sm text-center lg:text-left py-2 leading-8">
            {details
              ? details
